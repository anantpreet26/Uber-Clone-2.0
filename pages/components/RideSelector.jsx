...
function RideSelector( {pickupCoordinates, dropoffCoordinates ,props}) {
...
const Car = tw.div`flex justify-between items-center py-4 transform hover:bg-gray-200 transition`;
// const Cont = tw.div`flex justify-between items-center py-4 hover:bg-gray-200`;
